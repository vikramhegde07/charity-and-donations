                        ...
                        <form action="" method="post">
                            <div class="person-donate text-center">
                                ...
                                <div class="donate-info">
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control py-2" name="username" id="username" value="<?php echo $user['username']; ?>" placeholder="Enter username">
                                    </div>
                                    <div class="form-group">
                                        <input type="email" class="form-control py-2" name="email" id="email" value="<?php echo $user['email']; ?>" placeholder="Enter email">
                                    </div>
                                    <div class="form-group">
